...
import { ActiveSideOfGame, Move, PassiveSideOfGame } from "@daml-ts/chess-0.3.0/lib/Chess";
import { Coord, Piece, PieceType, Side, SplitGameState } from "@daml-ts/chess-0.3.0/lib/Types";
